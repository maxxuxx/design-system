...
- 공개 상태: npm 배포용 artifact는 검증하지만, 모든 workspace package는 아직 `private: true`입니다.
...
npm 배포 전 package artifact만 확인할 수도 있습니다.
...
20개 컴포넌트는 HDS v0.1.0에서 모두 `preview` 상태입니다. npm scope 소유권 확인과 첫 공개, `stable` 승격, Code Connect, Svelte와 React Native 구현은 후속 범위입니다.
